neutral.predict <- function(homeName, awayName, runCount){
  ...
  for(j in 1:runCount){
    ...
    homeExpectedPass[3] <- ((0.75*homeExpectedPass[1])+(1.25*homeExpectedPass[2]))/2 
    homeExpectedRun[3] <- ((0.75*homeExpectedRun[1])+(1.25*homeExpectedRun[2]))/2 
    
    awayExpectedPass[3] <- ((1.25*awayExpectedPass[1])+(0.75*awayExpectedPass[2]))/2 
    awayExpectedRun[3] <- ((1.25*awayExpectedRun[1])+(0.75*awayExpectedRun[2]))/2 
    
    homePointsFor[3] <- ((0.75*homePointsFor[1])+(1.25*homePointsFor[2]))/2 
    awayPointsFor[3] <- ((1.25*awayPointsFor[1])+(0.75*awayPointsFor[2]))/2 
