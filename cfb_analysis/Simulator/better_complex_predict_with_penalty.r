neutral.predict <- function(homeName, awayName, runCount){
  ...
  for(j in 1:runCount){
    ...
    homePointsFor[4] <- max(0,(1.75*(yardageMargin/100.0))+(1.25*penaltyMargin)+(-1.75*turnoverMargin)+homePointsFor[3])
    awayPointsFor[4] <- max(0,(-1.75*(yardageMargin/100.0))+(-1.25*penaltyMargin)+(1.75*turnoverMargin)+awayPointsFor[3])
...
predict <- function(homeName, awayName, runCount){
  ...
  for(j in 1:runCount){
    ...
    homePointsFor[4] <- max(0,3+(1.75*(yardageMargin/100.0))+(1.25*penaltyMargin)+(-1.75*turnoverMargin)+homePointsFor[3])
    awayPointsFor[4] <- max(0,(-1.75*(yardageMargin/100.0))+(-1.25*penaltyMargin)+(1.75*turnoverMargin)+awayPointsFor[3])
