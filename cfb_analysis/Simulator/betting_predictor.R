...
neutral.game <- function(row)
{
  ...
  game[["Home Score"]] <- max(0, (home.SoS.adjust*home.points))
  
  
  game[["Away Score"]] <- max(0, (away.SoS.adjust*away.points))
  return(game)
}
...
game <- function(row)
{
  ...
  game[["Home Score"]] <- max(0, 1.5+(home.SoS.adjust*home.points))
  
  
  game[["Away Score"]] <- max(0, -1.5+(away.SoS.adjust*away.points))
  return(game)
}
